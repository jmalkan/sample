steal("funcunit/qunit", "todo/fixtures", "todo/models/todo.js", function(){
	module("Model: Todo")
	...
	test("update" , function(){
		expect(2);
		stop();
		new Todo({name: "cook dinner", description: "chicken"}).
	            save(function(todo){
	...
	test("destroy", function(){
		expect(1);
		stop();
		new Todo({name: "mow grass", description: "use riding mower"}).
