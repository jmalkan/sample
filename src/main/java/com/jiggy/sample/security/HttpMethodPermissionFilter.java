...
public class HttpMethodPermissionFilter extends org.apache.shiro.web.filter.authz.HttpMethodPermissionFilter {
  ...
  private String getHttpMethodAction(String id, String restMethodAction, String requestURI, String requestURISuffix) {
    ...
    if (StringUtils.isBlank(id) || FIND_ALL_ID.equals(id)) {
      if (!StringUtils.isBlank(requestURISuffix) && !requestURISuffix.contains(FIND_PATH.substring(1))) operationName = requestURISuffix;
    } else {
    ...
    if (resourseName.equals(operationName))
      ...
      if (permissions == null || permissions.isEmpty()) operationName = restMethodAction;
    }
   ...
   * @return
   */
  private String getId(ServletRequest request, String requestURI, String methodAction, String requestURISuffix) {
    String id = null;
